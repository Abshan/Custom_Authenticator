 ...
 */
public class CustomServiceReferenceHolder {

    private static CustomServiceReferenceHolder instance = new CustomServiceReferenceHolder();
    ...
    public static CustomServiceReferenceHolder getInstance() {
        return instance;
    }

    private CustomServiceReferenceHolder() {
    }
    ...
    public static void setRealmService(RealmService realmService) {
        CustomServiceReferenceHolder.realmService = realmService;
    }
}